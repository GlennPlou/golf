public class Droite
{
	...
	public Point intersection(Droite d){
		if(-(this.b)*d.a - (-d.b*this.a) == 0){	//les droites sont paralleles ou confondues (vecteurs directeurs colineaires) = (-b * a')-(-b' * a)
			...
			float x = (-d.c + d.b*(this.c/this.b)) / (d.a - d.b*(this.a/this.b)); //Resolution du systeme d'equations, pour n'importe quel b (pas forcement -1)
...
//	}
//
//	public float appartient(Point p){
